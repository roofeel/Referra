...
const mockedControllers = {
  ...
  manualAttributedController: {
    listJobs: makeHandler("manualAttributed.listJobs"),
    createJob: makeHandler("manualAttributed.createJob"),
    getJob: makeHandler("manualAttributed.getJob"),
    updateJob: makeHandler("manualAttributed.updateJob"),
    deleteJob: makeHandler("manualAttributed.deleteJob"),
  },
  urlRulesController: {
...
const routeCases: RouteCase[] = [
  ...
  { method: "GET", path: "/api/manual-attribution/attributed/jobs", action: "manualAttributed.listJobs" },
  {
    method: "POST",
    path: "/api/manual-attribution/attributed/jobs",
    action: "manualAttributed.createJob",
    body: { name: "manual job", sqlTemplate: "select 1" },
  },
  {
    method: "GET",
    path: "/api/manual-attribution/attributed/jobs/job1",
    action: "manualAttributed.getJob",
    params: { jobId: "job1" },
  },
  {
    method: "PUT",
    path: "/api/manual-attribution/attributed/jobs/job1",
    action: "manualAttributed.updateJob",
    params: { jobId: "job1" },
    body: { name: "manual job updated" },
  },
  {
    method: "DELETE",
    path: "/api/manual-attribution/attributed/jobs/job1",
    action: "manualAttributed.deleteJob",
    params: { jobId: "job1" },
  },
